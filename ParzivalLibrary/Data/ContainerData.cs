...
namespace ParzivalLibrary.Data
{
    ...
    public class ContianerDetailData
    {
        ...
        public InvoicePallet get_pallet_id { get; set; }
    ...
    public class ContainerDetailObj : HttpResponseData
    {
        public List<ContianerDetailData> data { get; set; }
    }

    public class ContainerDetailResponse
    {
        public bool success { get; set; }
        public ContainerDetailObj data { get; set; }
        public object message { get; set; }
    }
