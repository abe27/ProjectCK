...
namespace ParzivalLibrary
{
    public class GediService
    {
        ...
        {
            var client = new RestClient($"{StaticVar.__rest_api}/api/v1/batch/{is_status}/{dateTime.ToString("yyyyMMdd")}/get");
            client.Timeout = -1;
        ...
        {
            var client = new RestClient($"{StaticVar.__rest_api}/api/v1/batch/{id}/update");
            client.Timeout = -1;
